            ...
            <ShearedCreation>
              <AttachAssets>
                <AssetsButton onClick={() => switchAssetArea("image")}>
                  <img src="images/shared-images.svg" alt="" />
                </AssetsButton>
...
const ShearedContent = styled.div`
  display: flex;
  flex-direction: column;
  flex-grow: 1;
  overflow-y: hidden;
...
const ShearedCreation = styled.div`
  display: flex;
  justify-content: space-between;
...
const PostButton = styled.button`
  ...
  &:hover {
    background: ${(props) => (props.disabled ? "rgba(0,0,0,0.8)" : "#004181")};
  }
`;
